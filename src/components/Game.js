...
const Game = () => {
        ...
        setAircraftPosition(prevPos => {
            ...
            switch (direction) {
                case 'up':
                    ...
                    break;
                case 'down':
                    newPos.y = newPos.y < 728 ? newPos.y + 20 : newPos.y;
                    break;
                case 'left':
                    newPos.x = newPos.x > 0 ? newPos.x - 20 : newPos.x;
                    break;
                case 'right':
                    newPos.x = newPos.x < 974 ? newPos.x + 20 : newPos.x;
                    break;
                default:
                    break;
            }
    ...
    const checkCollision = (aircraft, entity) => {
        ...
        const entityRect = { x: entity.x, y: entity.y, width: 40, height: 40 };
